...
module.exports = {
    VERSION: '🙂DIWAN🙂 1.0 beta',
    CHANNEL: 'https://youtube.com/watch?v=fAeEKYdm9xU',
    SESSION: process.env.DIWAN_SESSION === undefined ? '' : process.env.DIWAN_SESSION,
    FOOTER: process.env.FOOTER === undefined ? '𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝙱𝙾𝚃 ²⁰²²' : process.env.FOOTER,
    ...
    CAP_BIO: process.env.CAP_BIO === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 මම ²⁰²²' : process.env.CAP_BIO,
    CAPTION: process.env.CAPTION === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 මම ²⁰²²' : process.env.CAPTION,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://ibb.co/n1Dftk3' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
    INBOX_BLOCK: process.env.INBOX_BLOCK === undefined ? 'false' : process.env.INBOX_BLOCK,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? '*ALL IINBOX MESSAGES BLOECKED BY THE BOT OWNER*' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://ibb.co/n1Dftk3' : process.env.ALIVE_LOGO,
    ...
    DEPLOYER: process.env.DEPLOYER === undefined ? 'BOT USER' : process.env.DEPLOYER,
    DETAILS: process.env.DETAILS === undefined ? 'true' : process.env.DETAILS, 
    C_EMOJI: process.env.C_EMOJI === undefined ? '❤️' : process.env.C_EMOJI,
    D_EMOJI: process.env.D_EMOJI === undefined ? '😶' : process.env.D_EMOJI,
    BOT_NAME: process.env.BOT_NAME === undefined ? 'DIWANBOt' : process.env.BOT_NAME,
